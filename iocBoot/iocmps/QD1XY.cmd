...
dbLoadRecords ("db/restoreall.db","USER=QDX1,HWUNIT=qdx1")
dbLoadRecords("db/sys9100.db","USER=QDY1,HWUNIT=qdy1")
dbLoadRecords ("db/restoreall.db","USER=QDY1,HWUNIT=qdy1")
...
#Autosave
 ...
 set_pass0_restoreFile("pvsaveQD1XY.sav")
...
create_monitor_set("pvsaveQD1XY.req",2) #2 second
